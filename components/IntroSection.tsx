            ...
            <div className="container relative">
                <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-6">
                    <div className="text-sm md:text-base">
                        <Typing />
                        <h5 className="md:text-5xl md:leading-normal text-3xl leading-normal font-bold mt-3">Innovative Solutions  <br /> by Vimal Raj</h5>
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <div className="">
                                <Link href="/resume/newvimaldeveloper.pdf" target="_blank" download="Vimal_Raj" className="py-2 px-2 whitespace-nowrap md:px-5 inline-flex items-center font-medium tracking-wide border align-middle duration-500 text-[10px] md:text-base text-center bg-custom-gradient hover:[#5138ee] border-[#5138ee] hover:border-[#5138ee] text-white rounded-xl">Download CV <i className="mdi mdi-arrow-right ms-2"></i></Link>
                            </div>
                            <div className="flex items-center gap-4">
                                <Link href="mailto:vimalraj87464@gmail.com" target='_blank' className=" w-10 h-10 cursor-pointer bg-white  rounded-full relative inline-block text-center">
                                ...
                                <Link href="https://www.linkedin.com/in/vimal-raj-software-deveoper/" target='_blank' className=" w-10 h-10 cursor-pointer bg-white  rounded-full relative inline-block text-center">
                                ...
                                <Link href="https://github.com/vimalraj687" target='_blank' className=" w-10 h-10 cursor-pointer bg-white  rounded-full relative inline-block text-center">
                    ...
                    <div className="relative lg:ms-6 ">
                        <div className="relative z-1">
                            ...
                            <div className="absolute lg:bottom-20 -bottom-5 md:-start-10 -start-2 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 m-3 w-44 text-center">
                                <span className="text-3xl font-medium mb-0"><span className="counter-value font-bold" data-target="125">10</span>+</span>
