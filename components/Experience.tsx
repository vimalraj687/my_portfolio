                ...
                <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 className=" text-base md:text-xl font-semibold">Front-end Developer</h3>
                                <p className="">Zonvoir Technology Pvt Ltd</p>
                                <p className=" bg-custom-gradient text-white px-2 py-1 inline-block rounded mt-2">January 2023 - February 2024</p>
                            </div>
                        </div>
