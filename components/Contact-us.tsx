            ...
            <div className="ml-8 mb-4">
                ...
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <div className="flex items-center gap-2">
                            <Link href="mailto:vimalraj87464@gmail.com" className=" w-10 h-10 cursor-pointer bg-custom-gradient rounded-lg relative inline-block text-center">
                                <Mail className='text-white absolute p-1 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' size={32} />
                            </Link>
                            <p className="text-gray-600 mt-2"> vimalraj87464@gmail.com</p>
                        </div>
                    </div>
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <div className="flex items-center gap-4">
                            <Link href="https://www.linkedin.com/in/vimal-raj-software-deveoper/" target="_blank" className=" w-10 h-10 cursor-pointer bg-custom-gradient rounded-lg relative inline-block text-center">
                                <Linkedin className='text-white absolute p-1 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' size={32} />
                            </Link>
                            <Link href="https://github.com/vimalraj687" target="_blank" className=" w-10 h-10 cursor-pointer bg-custom-gradient rounded-lg relative inline-block text-center">
