        ...
        <div id="topnav" className="">
            <nav className="relative py-5  container flex items-center justify-between">
                ...
                <ul className="flex items-center space-x-8 lg:flex">
                    <li>
                        <Link   href="/resume/newvimaldeveloper.pdf" target="_blank" download="Vimal_Raj" className="inline-block bg-custom-gradient text-white py-2 px-4 rounded-lg shadow-lg hover:bg-blue-700 transition">
                            Hire me
                        </Link> 
                    </li>
