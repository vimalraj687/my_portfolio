            ...
            <div className="w-full md:w-1/2 ">
                <div className="space-y-4">
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 className=" text-xl font-semibold">Diploma - Computer Science and Engg.</h3>
                            <p className="">BOARD OF TECHNICAL EDUCATION UTTAR PRADESH LUCKNOW</p>
                            <p className=" bg-custom-gradient text-white px-2 py-1 inline-block rounded mt-2">2016 - 2019</p>
                        </div>
                        <div>
                            ...
                            <p className=" bg-custom-gradient text-white px-2 py-1 inline-block rounded mt-2">2023 - Present</p>
                        </div>
                    </div>
