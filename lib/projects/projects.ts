export const projects = [
    {
        id: 1,
        name: "8thElement",
        tag: "Medical Software solutions  ",
        description: `At 8th Element, we empower healthcare organizations with smart, tech-driven solutions to enhance patient care, streamline operations, and drive innovation. Our platform integrates advanced analytics, AI, and user-friendly interfaces to transform healthcare delivery, ensuring better outcomes for patients and providers alike.`,
        imgags: '/images/theelement.png',
        techStack: ['react js, next js, sanity'],
        url: 'https://theelements-h4sv.vercel.app/'
    },
    {
        id: 2,
        name: "Orancia.com",
        tag: "Beauty Ecommerce",
        description: `Orancia is India’s leading beauty and wellness destination, offering 100% authentic products from 2400+ global and Indian brands across makeup, skincare, haircare, and more—online and in-store. With expert advice, beauty content, and personalized service, Orancia celebrates the star in every woman.`,
        imgags: '/images/orancia.png',
        techStack: ['react js, next js, mongoDB, node js'],
        url: "http://localhost:3001/"
    },
    {
        id: 3,
        name: "Difmo",
        tag: "Difmo Technologies, Digital Transformation",
        description: `Difmo Technologies empowers businesses through innovative digital solutions—ranging from custom software and AI to cloud and automation—driving transformation, growth, and long-term impact.`,
        imgags: '/images/difmo.png',
        techStack: ['react js, next js, mongoDB'],
        url: "https://www.difmo.com/"
    },
    {
        id: 4,
        name: "Shamila",
        tag: "Business Consulting services",
        description: `Frontend Developer for Shamila eCommerce App, building a responsive mobile shopping experience using React Native. Implemented intuitive UI/UX designs and integrated key features for seamless performance across devices.`,
        imgags: '/images/shamila.jfif',
        techStack: ['react Native, mongoDB'],
        url: "https://play.google.com/store/apps/details?id=com.mmhshamila&hl=en"
    },
    // {
    //     id: 5,
    //     name: "Zonvoir.com",
    ...
    },
    {
        ...
        name: "Ecommerce App",
        tag: " ",
        description: `Developed and maintained front-end for both Admin and User Panels, implementing features like Signup, Login, Forgot Password, and Add to Cart. Enhanced user experience with optimized product management UI and integrated a secure Payment Gateway.`,
        imgags: '/images/exommerce.PNG',
        techStack: ['react js, next js, mongoDB'],
        url: "#"
    },
    {
